    ...
    return `
        ...
        <div class="tab-content" id="businessManagementTabsContent">
            <div class="tab-pane fade ${activeTab === 'businesses' ? 'show active' : ''}" id="businesses-content" role="tabpanel">
                <div class="card shadow-sm">
                    <div class="card-header d-flex justify-content-between align-items-center bg-light">
                        <h5 class="mb-0">Listado de Negocios</h5>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                <thead><tr><th>Nombre del Negocio</th><th>Compañía Matriz</th><th>Estado</th><th>Acciones</th></tr></thead>
                                <tbody>${businessRows.length > 0 ? businessRows : `<tr><td colspan="4" class="text-center text-muted fst-italic py-3">No se encontraron negocios.</td></tr>`}</tbody>
                            </table>
                        </div>
                    </div>
            ...
            <div class="tab-pane fade ${activeTab === 'companies' ? 'show active' : ''}" id="companies-content" role="tabpanel">
                <div class="card shadow-sm">
                    <div class="card-header d-flex justify-content-between align-items-center bg-light">
                        <h5 class="mb-0">Listado de Compañías</h5>
                     ...
                     <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                <thead><tr><th>Nombre Legal</th><th>CIF</th><th>Estado</th><th>Acciones</th></tr></thead>
                                <tbody>${companyRows.length > 0 ? companyRows : `<tr><td colspan="4" class="text-center text-muted fst-italic py-3">No se encontraron compañías.</td></tr>`}</tbody>
                            </table>
                        </div>
                    </div>
